...
/*
	...
	authenticity. To create the web color #
	RRGGBB, use color.RGBA{0x
	RR, 0x
	GG, 0x
	BB, 0xff},
...
var palette = []color.Color{color.RGBA{11, 156, 49, 1}, color.Black, color.RGBA{255, 156, 4, 1}, color.White}
